# -*- coding: utf-8 -*-
#
# pytest-glint-prodweb documentation build configuration file, created by
...
project = u'pytest-glint-prodweb'
copyright = u'2015, Eric Medina'
author = u'Eric Medina'
...
man_pages = [
    (master_doc, 'pytest-cookiecutterplugin_name', u'pytest-glint-prodweb Documentation',
     [author], 1)
]
